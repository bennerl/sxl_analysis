...
write.table(exon_pos_fc, "~/sxl_data/data_tables/exon_pos_fc_annot.txt", row.names = F, col.names = T, quote = F, sep = "\t")
write.table(exon_neg_fc, "~/sxl_data/data_tables/exon_neg_fc_annot.txt", row.names = F, col.names = T, quote = F, sep = "\t")
write.table(gene_pos_fc, "~/sxl_data/data_tables/gene_pos_fc_annot.txt", row.names = F, col.names = T, quote = F, sep = "\t")
write.table(gene_neg_fc, "~/sxl_data/data_tables/gene_neg_fc_annot.txt", row.names = F, col.names = T, quote = F, sep = "\t")
